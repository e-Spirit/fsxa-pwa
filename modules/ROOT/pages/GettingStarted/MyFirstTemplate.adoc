...
. <<Development Mode>>
. link:TSX-Components.html[Writing JSX/TSX Components]
. link:SFC-Components.html[Writing Single File Components]
...
If you prefer the classic vue single file component style link:SFC-Components.html[this guide] is for you.

If you come from react and are already familiar with JSX/TSX or you are curious and would like to get started with it link:TSX-Components.html[this guide] is for you.
