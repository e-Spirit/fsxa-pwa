...
== Circular References Notes
The following notes are used to indicate that there maybe some unwanted behavior of the application when using circular references data in your content. For example, a page that references itself as a child page. This can cause unwanted behavior of the application when you try to do some logging or debugging. You need to use as little circular references data as possible.
