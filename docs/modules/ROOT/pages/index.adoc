...
[arabic]
.. link:Introduction#general[General]
.. link:Introduction#projects-used[Projects used]
.. link:Introduction#architecture[Architecture]
.. link:Introduction#deployment[Deployment]
