...
Returns the name of the editor input componenten in the FirstSpirit template. This optional property enables the "Inline Editing" feature of xref:advanced/TPP-Snap.adoc[TPP Snap]
