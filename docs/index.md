...
2. [Getting Started](./GettingStarted/index.md)
   1. [My First Template](./GettingStarted/MyFirstTemplate.md)
   2. [Adding CSS](./GettingStarted/CustomCSS.md)
   3. [Changing the App Layout](./GettingStarted/ChangingtheAppLayout.md)
...
8. [Custom CSS](css/index.md)
   1. [Adding Custom CSS to your Components](css/Component.md)
   2. [Removing Tailwind CSS from your Project](css/RemovingTailwind.md)
9. [ProjectProperties](ProjectProperties.md)
10. [Working with Images](WorkingWithImages.md)
    1. [Introduction](WorkingWithImages.md#introduction)
    2. [Working with CaaS](WorkingWithImages.md#working-with-caas)
    3. [Resolutions in FirstSpirit](WorkingWithImages.md#resolutions-in-firstspirit)
    4. [Responsiveness](WorkingWithImages.md#responsiveness)
    5. [Lazy Loading](WorkingWithImages.md#lazy-loading)
    6. [SourceSets](WorkingWithImages.md#source-sets)
